...
import { View, Text, TextInput, ScrollView, TouchableOpacity, Image, SafeAreaView, StatusBar, FlatList, ActivityIndicator, Modal, Alert, KeyboardAvoidingView, Platform } from 'react-native';
...
const KathavachakRegister = ({ navigation }) => {
    ...
    const fetchPlans = async () => {
        try {
            ...
            const response = await axios.get(KATHAVACHAK_PLANS, { headers });
        ...
        <SafeAreaView style={Globalstyles.container} edges={['top', 'bottom']}>
            ...
            <View style={Globalstyles.header}>
                <View style={{ flexDirection: 'row', alignItems: "center" }}>
                    ...
                    <Text style={Globalstyles.headerText}>Kathavachak Register</Text>
                </View>
            </View>
            ...
            >
                <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled" contentContainerStyle={{ paddingBottom: insets.bottom + SH(50), flexGrow: 1 }}>
                    <View style={Globalstyles.form} importantForAutofill="no" removeClippedSubviews={true}>
                        ...
                        {errors?.kathavachakServices && <Text style={styles.errorText}>{errors.kathavachakServices}</Text>}
